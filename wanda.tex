...
\affil{Informatics Research Center, Politeknik Pos Indonesia}
%Floyd J. Fowler, Jr.\\
%\affil{University of New Mexico}
}

\offprintinfo{Voice Cloning, First Edition}{Dinda Majesty et al}
...
\input{chapter/Tentang_TTS}

\chapter{Neural Network}
\input{chapter/neural_network}

\chapter{Sequence to Sequence (Seq2Seq)}
\input{chapter/SeqtoSeq}

\chapter{Speech Synthesis}
\input{chapter/Speech_Synthesis}

\chapter{Voice Cloning}
\input{chapter/Voice_Cloning}

\chapter{Tacotron-2}
\input{chapter/Tacotron2}

\chapter{WaveNet}
\input{chapter/WaveNet}

\chapter{Multi-Speaker Voice Cloning}
\input{chapter/SV2TTS}

\chapter{Tutorial Pembuatan Multi-Speaker Voice Cloning}
\input{chapter/tutorial}

\chapter{Tutorial Pembuatan Project Menggunakan Google Colab}
\input{chapter/tutorial_colab}

\chapter{Result, Error, and Solution}
\input{chapter/hasil}
